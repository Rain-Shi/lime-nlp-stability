...
plt.show()
```
This global bar plot highlights the top 20 words across all tweets, regardless of class. Words like "SpeakerPelosi", "diamond", and "AWESOME" dominate, showing that they were consistently influential in driving the model's decisions. This visualization offers a high-level summary of what the model deems important overall.
