...
val = val.sample(10, random_state=1)
...
#2. Run LIME and Collect Word Importances
```{python}
import emoji
...
```
#4. Overall Top 20 Word Importance
```{python}
...
6. Stability Analysis under Synonym Substitution
```{python}
